...
INPUT_FILES = {
    ...
    'propedia_v2': ['local_data/intermediate_product/Propedia_v2_with_HELM_SMILES.csv'],
...
PRIORITY_ORDER = ['cycpeptmpdb', 'propedia_v2', 'chembl']
...
def main():
    ...
    for dataset_name, df in datasets.items():
        if dataset_name == 'chembl':
            # ChEMBL from v2 processing gets v2 suffix
            output_file = output_path / "chembl_v2_deduplicated.csv"
        else:
